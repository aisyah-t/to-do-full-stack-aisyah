      ...
      <div>
        ...
        <h2>Add A New Task!</h2>
          ...
          <div className='form-row'>
            ...
            <input type="text" name="priority" defaultValue="0=False, 1=True" className='form input' onChange={this.handleChange} />
          </div>

          <div className='form-row'>
            <label >Completed</label>
            <input type="text" name="completed" defaultValue="0=False, 1=True" className='form input' onChange={this.handleChange} />
          </div>
